...
import cn.com.wechat.entity.Face;
...
public class FaceService {
	...
	try {
	    ...
	    queryUrl = queryUrl.replace("API_KEY", "fa830473eab1a2eca5fae97584ab3926");
	    queryUrl = queryUrl.replace("API_SECRET", "-oXFs0zR2P1qsClC4o3fPYLmVX8uJWyC");
	    // 调用人脸检测接口
	    String json = HttpUtil.doGet(queryUrl);
	    // 解析返回json中的Face列表
